...
const ContactForm = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-pink-100">
            <div className="border border-pink-700 max-w-md w-full p-6 bg-black rounded-lg shadow-lg">
                {!submitted ? (
                    ...
                    <div className="mt-4 text-lg text-white text-center">
                        <p>Nama: <span className="font-semibold">{name}</span></p>
                        <p>Email: <span className="font-semibold">{email}</span></p>
                        <p>Pesan: <span className="font-semibold">{message}</span></p>
                        <p>Rating: <span className="font-semibold">{rating} Star{rating > 1 ? 's' : ''}</span></p>
